...
In this directory, you can find the distributed version of these fonts. Aside from removing some unneeded `ttf` and `fontconfig` files, this is the same as the distribution from the DejaVu team, licensing at all.
